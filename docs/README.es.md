...
Las tarjetas y el JSON crudo vienen de un `/invoke` local real sobre `examples/safe_candidate.json`
(**approve**, score `100`) y una mutación fail-closed (**reject**). Capability:
...
[Admisión](https://github.com/alexar76/aicom/blob/main/docs/ecosystem/supply-chain-admission-es.md).
