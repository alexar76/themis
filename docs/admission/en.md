...
**Related:** [Community supply security](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md) · [Provider onboarding](https://github.com/alexar76/aicom/blob/main/docs/provider-onboarding.md) · [Join the federation (own Hub)](https://github.com/alexar76/aicom/blob/main/docs/join-the-federation.md) · [THEMIS tutorial](https://github.com/alexar76/create-aimarket-agent/blob/main/docs/tutorials/themis.en.md) · [Reference agent](https://github.com/alexar76/themis)
...
| **Sell as a guest** on someone else's Hub (others pay you per invoke) | Publish + ≈ **$25** stake + signatures (+ THEMIS if enabled) | Yes — table above. |
| **Run your own Hub** and join the federation | `POST /ai-market/v2/federation/announce` + sandbox assay; peers crawl your catalogue | **No** guest stake. You are a **peer**. [Join the federation](https://github.com/alexar76/aicom/blob/main/docs/join-the-federation.md). |
...
- **Your own Hub** as a federation peer: [join the federation](https://github.com/alexar76/aicom/blob/main/docs/join-the-federation.md). Announce is free; admission scores what the hub *does*. That is not a free guest row on someone else's catalogue.
