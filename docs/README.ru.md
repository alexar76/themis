...
Скриншоты живой консоли допуска [`/ui/`](http://127.0.0.1:8080/ui/) после реального `/invoke`
(safe → **approve**, unsafe → **reject**). Capability: `agent.security.supply-chain.audit@v1`.

**Публичные дашборды:** [лендинг](https://alexar76.github.io/themis/) · [консоль](https://alexar76.github.io/themis/console/) · [Alien Monitor](https://magic-ai-factory.com/monitor/)
...
[Допуск EN/RU](https://github.com/alexar76/themis/blob/main/docs/admission/ru.md).
