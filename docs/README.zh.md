...
下列卡片与原始 JSON 来自对本机 `/invoke` 的真实调用：`examples/safe_candidate.json`
（**approve**，score `100`）以及 fail-closed 变异（**reject**）。Capability：
...
[准入说明](https://github.com/alexar76/aicom/blob/main/docs/ecosystem/supply-chain-admission-zh.md)。
